      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col items-center md:items-start gap-1">
          <span className="font-display font-black text-lg uppercase">
            ...
            <span className="text-foreground ml-1 font-handwritten text-lg font-light tracking-wider normal-case">by</span>
            <span className="text-foreground ml-1 font-handwritten text-lg font-light tracking-wider normal-case">Katja</span>
          </span>
